...
# Nesta versao nao ha nenhum trecho de codigo gerado por IA. O FCFS
# entregue e' o proprio codigo-base da disciplina, estudado e mantido sem
# alteracoes, e as funcoes SJF(), PRIORIDADE() e Round_Robin() seguem como
# os esqueletos do codigo-base, a serem implementados nas entregas 2, 3 e 4.
